 ...
 */
package com.typicalbot.nxt.command.webhook;
...
@CommandConfiguration(category = CommandCategory.WEBHOOK, aliases = "webhook")
public class WebhookCommand implements Command {
    @Override
